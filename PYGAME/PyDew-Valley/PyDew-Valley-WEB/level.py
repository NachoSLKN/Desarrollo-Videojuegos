...
class Level:
    ...
    def __init__(self, player_name="Nacho"):
        ...
        print("LEVEL 1: Inicio")

        self.player_name = player_name
        self.display_surface = pygame.display.get_surface()

        print("LEVEL 2: Creando grupos")
        ...
        print("LEVEL 3: Creando SoilLayer")
        ...
        print("LEVEL 4: Cargando mapa y jugador")

        self.setup()

        print("LEVEL 5: Creando interfaz")

        self.overlay = Overlay(self.player)
        self.hud = HUD(self.player, self.player_name)
        self.transition = Transition(self.reset, self.player)

        print("LEVEL 6: Creando clima")
        ...
        print("LEVEL 7: Creando tienda")

        self.menu = Menu(self.player, self.toggle_shop)
        self.shop_active = False

        # Audio desactivado temporalmente para localizar el bloqueo Web.
        # self.success = load_sound(
        #     resource_path('project/audio/success.wav')
        # )
        # self.success.set_volume(0.3)
        # self.music = load_sound(
        #     resource_path('project/audio/music.mp3')
        # )
        # self.music.play(loops=-1)
        # self.music.set_volume(0.1)

        print("LEVEL 8: Level terminado")

    def setup(self):

        print("SETUP 1: Cargando TMX")

        tmx_data = load_pygame(
            resource_path('project/data/map.tmx')
        )

        print("SETUP 2: TMX cargado")
        ...
        Generic(
            ...
            surf=pygame.image.load(
                resource_path('project/graphics/world/ground.png')
            ).convert_alpha(),
            groups=self.all_sprites,
            z=LAYERS['ground']
        )

        print("SETUP 4: Setup terminado")

    def player_add(self, item):
        self.player.item_inventory[item] += 1

        # Sonido desactivado temporalmente para Web.
        # self.success.play()
    ...
    def reset(self):
            ...
            # volver a crear Ã¡rboles desde el TMX
...
class CameraGroup(pygame.sprite.Group):
    ...
    def custom_draw(self, player):
        ...
        # DEBUG DEL JUGADOR: se dibuja una sola vez y en su posiciÃ³n real.
        # Comenta estas lÃ­neas cuando termines de probar las colisiones.
        # DEBUG DEL JUGADOR
        if DEBUG:
