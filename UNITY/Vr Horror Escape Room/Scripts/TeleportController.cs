...
public class TeleportController : MonoBehaviour
{
 ...
 //         bool lbIsLeftInteractorRayHover = mLeftInteractor.TryGetHitInfo( out Vector3 position, out Vector3 normal, out int index, out bool isValidTarget);
 //   if (!lbIsLeftInteractorRayHover)
	//{
...
//{
//bool lbIsRightInteractorRayHover = mRightInteractor.TryGetHitInfo(out Vector3 position, out Vector3 normal, out int index, out bool isValidTarget);
...
//        TeleportRequest 1Request = new TeleportRequest()
...
//        mTeleportationProvider.QueueTeleportRequest (1Request);
//    }
